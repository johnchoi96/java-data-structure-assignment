...
public class MergeSortMachineTest extends SortMachineTest {

    @Test
    public void testMergeSortWithInteger() {
    ...
    public void testMergeSortWithString() {
        ...
        SortingMachine<String> sm = new MergeSortMachine<>(originalList);
